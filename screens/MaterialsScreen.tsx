  ...
  return (
    <div className="p-5 flex flex-col gap-6">
      <div className="space-y-1">
        <h3 className="text-[#eab308] text-2xl font-bold tracking-tight uppercase">Materiais e Dureza</h3>
        <p className="text-gray-500 text-sm">Guia técnico para seleção de ferramentas.</p>
      </div>

      <div className="bg-gradient-to-r from-[#eab308]/20 to-transparent border-l-4 border-[#eab308] p-4 rounded-r-xl">
        <p className="text-[#eab308] text-xs font-bold uppercase mb-1 tracking-wider">Dica Técnica</p>
        <p className="text-sm text-gray-400">Durezas indicadas para o estado de fornecimento padrão (recozido).</p>
      </div>
          ...
          <div key={mat.name} className="bg-[#252930] rounded-2xl border border-white/5 overflow-hidden shadow-lg group">
            ...
            <div className="p-4 grid grid-cols-2 gap-4 bg-[#121214]/40">
              <div className="space-y-3">
                <div>
                   <p className="text-[10px] text-gray-500 uppercase font-bold tracking-tighter">Usinabilidade</p>
                ...
                <div>
                   <p className="text-[10px] text-gray-500 uppercase font-bold tracking-tighter">Resistência Tração</p>
